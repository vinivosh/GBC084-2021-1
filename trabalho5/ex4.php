...
<head>
    ...
    <title>Ex. 4 — Lendo Arquivos</title>
    <style>
        html,body,.container {
            font-size: 16pt;
...
<body>
    ...
    <div class="container my-3">
        <h1 class="mb-5">Ex. 4 — Lendo Arquivos com <strong>PHP</strong></h1>
        ...
        <main>
            ...
            $email = htmlspecialchars(carregaString($fileEmail));
            $passHash = htmlspecialchars(carregaString($filePassHash));
